    ...
    throws ServletException, IOException {
       ...
       //check du lieu
        ...
        if(account==null){
            ...
            //dung old pass
            User ac = new User(account.getId(), u, np, account.getName(), account.getEmail(), account.getPhone_number(), account.getAddress(), account.getRole_id());
            ud.change(ac);
