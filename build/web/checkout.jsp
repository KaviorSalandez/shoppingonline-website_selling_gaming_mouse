<%-- 
    Document   : checkout
    Created on : Oct 29, 2022, 9:08:32 AM
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-8 col-md-6">
                                                            ...
                                                            <div class="checkout__input">
                                                                ...
                                                                <input type="text" placeholder="Street Address" class="checkout__input__add" name="address" value="${a.address}">
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <div class="checkout__input">
                                                                        <p>Phone<span>*</span></p>
                                                                        <input type="text" name="phone" value="${a.phone_number}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div class="checkout__input">
                                                            ...
                                                            <div class="checkout__order">
                                                                ...
                                                                <ul>
                                                                    <c:forEach items="${o.items}" var="i"> 
                                                                        ...
                                                                        <li>${i.product.title} <span>${i.quantity*i.price}$</span></li>
                                                                        </c:forEach>
                                                                </ul>
                                                                <div class="checkout__order__total">Total <span>${sessionScope.TotalMoney}$</span></div>
                                                                <button type="submit" class="site-btn">PLACE ORDER</button>
                                                            </div>
                                                            <h3 style="color:green">${sessionScope.ordersuccess}</h3>    
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
