            ...
            <div class="table-responsive">
                   <div class="table-wrapper">
                    <div class="table-title">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <h2>Info about Mouse Store Web <b></b></h2>
                            </div>
                            <div class="col-sm-6">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>${requestScope.totalIncome}$</td>
                                </tr>
                ...
                <div class="table-wrapper">
                    <div class="table-title">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <h2>Top 5 Users with the most orders<b></b></h2>
                            </div>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <c:forEach var="a" items="${requestScope.listTop5}">
