<%-- 
    ...
    Created on : Oct 19, 2022, 4:43:57 PM
        ...
        <section class="product-details spad">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <form action="buy" name="f" method="get">
                            <div class="product__details__text">
                                <h3>${p.title}</h3>
                                <div>
                                    <c:if test="${p.discount == 0}">
                                        <h4 class="product__details__price">${p.price}$</h4>
                                    </c:if>
                                    <c:if test="${p.discount != 0}">
                                        <h4 class="product__details__price">${p.price-(p.price*p.discount/100)}$
                                            <del style="color: gray; font-size: 20px">${p.price}$</del>
                                        </h4>
                                    </c:if>
                                </div>
                                <p>${p.description}</p>
                                ...
                                <p>Model: ${p.model}</p>
                                <p>Color: ${p.color}</p>
                                <form action="buy" method="get" id="myform"> 
                                ...
                                <button onclick="buy('${p.id}')" class="primary-btn" >ADD TO CARD</button>
                        ...
                        <ul>
                            <c:if test="${p.stock >0}">
                                <li><b>Availability</b> <span style="color:green">In Stock</span></li>
                                </c:if>
                                <c:if test="${p.stock <=0}">
                                <li><b>InAvailability</b> <span style="color:red">Out Of Stock</span></li>
                                </c:if>
                            <li><b>Share on</b>
                                <div class="share">
                                    <a href="#"><i class="fa fa-facebook"></i></a>
