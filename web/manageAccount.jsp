<%-- 
    Document   : crud
    Created on : Oct 22, 2022, 2:36:28 PM
                    ...
                    <div class="table-title">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <a href="home" class="btn btn-primary"> <span>Back to home</span></a>						
                            </div>
                        </div>
                        ...
                        <tbody>
                            <c:forEach var="a" items="${requestScope.listA}">
                                ...
                                <tr>
                                    ...
                                    <td>${(a.role_id==1)?"Admin":"User"}</td>
                                    <td>
                                        <a href="loadAccountToEdit?aid=${a.id}"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
<!--                                        <a href="#" onclick="doDelete('${a.id}')" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>-->
                                    </td>
                                </tr>
                        ...
                        <ul class="pagination">
                            ...
                            <div style="text-align: right;margin-bottom: 10px">
                                <c:forEach begin="${1}" end="${requestScope.num}" var="i">
                                    <a style="background: #EBEBEB;padding: 10px" href="manageAccount?page=${i}" >${i}</a>
                                </c:forEach>
                            </div>
                        </ul>
                    </div>
                    ...
                    <form action="addAccount" method="get">
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                                ...
                                <input name="password" type="text" class="form-control" required></input>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input name="role" type="radio"  value="2"/>User
                            </div>
                ...
                <div class="modal-content">
                    <form>
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                                <label>Model</label>
                                <input name="model" type="text" class="form-control" required></input>
                            </div>
                            <div class="form-group">
                                <label>Color</label>
                            ...
                            <div class="form-group">
                                <label>Stock</label>
                                <input name="stock" type="text" class="form-control" required></input>
                            </div>
                            <div class="form-group">
                                <label>Image</label>
                                <input name="image" type="text" class="form-control" required></input>
                            </div>

                            <div class="form-group">
                                <label>Discount</label>
                                <input name="discount" type="text" class="form-control" required></input>
                            </div>
